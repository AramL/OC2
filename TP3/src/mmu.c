...
void mmu_mapear_pagina  (uint virtual, uint cr3, uint fisica, uint attrs){
    ...
    if(PD == NULL){
        ...
        (PD[posicion_DR*4])[posicion_DT*4] = (fisica << 12) + attrs;        /* Copio la direccion fisica shifteada dejando 12 bits
                                                                             * para los atributos y le pego los mismos al final
                                                                             */
    }
}
...
uint mmu_unmapear_pagina(uint virtual, uint cr3){
    ...
    (PD[posicion_DR*4])[posicion_DT*4] = NULL;  
}
