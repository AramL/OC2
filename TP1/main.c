...
// 	printf("%s\n", nodo_test->palabra);
	...
	// oracionImprimir(lista_imp, "salida.txt", palabraImprimir );
	...
	/**   TESTS INSERTAR ORDENADO  **/
	lista *lista_testInsertarOrdenado = oracionCrear();
	
	//char *cat = palabraCopiar("Cat");
	...
	//insertarOrdenado(lista_testInsertarOrdenado, palabraCopiar("Dog"), palabraMenor);
	
	oracionImprimir(lista_testInsertarOrdenado, "ordenado.txt", palabraImprimir);
...
*/
	...
	// /**  TESTS FILTRAR PALABRA  **/

	lista *A = oracionCrear();
	insertarAtras(A, palabraCopiar("hola"));
	printf("%d\n", palabraMenor("hola", "quilo"));
	filtrarPalabra( A, palabraMenor, "quilo" );
	oracionImprimir( A, "testFiltrar", palabraImprimir );
	printf("%d\n", palabraMenor("hola", "quilo"));
	filtrarPalabra( A, palabraMenor, "alo" );
	oracionImprimir( A, "testFiltrar", palabraImprimir );	

	// lista *lista_filtrar = oracionCrear();
	// insertarAtras(lista_filtrar, palabraCopiar("Cat"));
	// filtrarPalabra(lista_filtrar, palabraIgual, "Cat");
	// oracionImprimir(lista_filtrar, "testFiltrarPalabra", palabraImprimir);

	// oracionBorrar(lista_filtrar);
...
/*	insertarAtras(lista_mensajeDiabolico, palabraCopiar("Mensaje"));
	...
	insertarAtras(lista_mensajeDiabolico, palabraCopiar("Mensaje"));
	insertarAtras(lista_mensajeDiabolico, palabraCopiar("dd"));
	insertarAtras(lista_mensajeDiabolico, palabraCopiar("Diabolo"));
	insertarAtras(lista_mensajeDiabolico, palabraCopiar("Mensaje"));
	insertarAtras(lista_mensajeDiabolico, palabraCopiar("dac"));
	insertarAtras(lista_mensajeDiabolico, palabraCopiar("Diabolo"));
	insertarAtras(lista_mensajeDiabolico, palabraCopiar("Mensaje"));
	insertarAtras(lista_mensajeDiabolico, palabraCopiar("dec"));
	insertarAtras(lista_mensajeDiabolico, palabraCopiar("Diabolo"));
*/
	//descifrarMensajeDiabolico(lista_mensajeDiabolico, "mensaje.txt", palabraImprimir);
