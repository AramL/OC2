...
# for i in {1..50} 
# do 
#   ./build/tp2 -i asm blur ././experimentos/tests_size/tests_size/game-584x584.bmp 5 5 | cut -d':' -f2 | sed '9,9!d' | xargs echo -n | tee -a ./python/tests_blur/test_radio_size_ASM
...
# for i in {1..50} 
# do 
#   ./build/tp2 -i asm blur ././experimentos/tests_size/tests_size/game-584x584.bmp 5 10 | cut -d':' -f2 | sed '9,9!d' | xargs echo -n | tee -a ./python/tests_blur/test_radio_size_ASM
#   echo -n " " >> ./python/tests_blur/test_radio_size_ASM
# done
...
# for i in {1..50} 
# do 
#   ./build/tp2 -i asm blur ././experimentos/tests_size/tests_size/game-584x584.bmp 5 25 | cut -d':' -f2 | sed '9,9!d' | xargs echo -n | tee -a ./python/tests_blur/test_radio_size_ASM
#   echo -n " " >> ./python/tests_blur/test_radio_size_ASM
# done
...
# for i in {1..50} 
# do 
#   ./build/tp2 -i asm blur ././experimentos/tests_size/tests_size/game-584x584.bmp 5 50 | cut -d':' -f2 | sed '9,9!d' | xargs echo -n | tee -a ./python/tests_blur/test_radio_size_ASM
#   echo -n " " >> ./python/tests_blur/test_radio_size_ASM
# done
...
# for i in {1..50} 
# do 
#   ./build/tp2 -i asm blur ././experimentos/tests_size/tests_size/game-584x584.bmp 5 75 | cut -d':' -f2 | sed '9,9!d' | xargs echo -n | tee -a ./python/tests_blur/test_radio_size_ASM
#   echo -n " " >> ./python/tests_blur/test_radio_size_ASM
# done
...
# for i in {1..50} 
# do 
#   ./build/tp2 -i asm blur ././experimentos/tests_size/tests_size/game-584x584.bmp 5 100 | cut -d':' -f2 | sed '9,9!d' | xargs echo -n | tee -a ./python/tests_blur/test_radio_size_ASM
#   echo -n " " >> ./python/tests_blur/test_radio_size_ASM
# done
...
# for i in {1..50} 
# do 
#   ./build/tp2 -i asm blur ././experimentos/tests_size/tests_size/game-584x584.bmp 5 150 | cut -d':' -f2 | sed '9,9!d' | xargs echo -n | tee -a ./python/tests_blur/test_radio_size_ASM
#   echo -n " " >> ./python/tests_blur/test_radio_size_ASM
# done
...
# for i in {1..50} 
# do 
#   ./build/tp2 -i asm blur ././experimentos/tests_size/tests_size/game-584x584.bmp 5 200 | cut -d':' -f2 | sed '9,9!d' | xargs echo -n | tee -a ./python/tests_blur/test_radio_size_ASM
#   echo -n " " >> ./python/tests_blur/test_radio_size_ASM
# done
...
# for i in {1..50} 
# do 
#   ./build/tp2 -i asm blur ././experimentos/tests_size/tests_size/game-584x584.bmp 5 250 | cut -d':' -f2 | sed '9,9!d' | xargs echo -n | tee -a ./python/tests_blur/test_radio_size_ASM
#   echo -n " " >> ./python/tests_blur/test_radio_size_ASM
# done
...
# for i in {1..50} 
# do 
#   ./build/tp2 -i c blur ././experimentos/tests_size/tests_size/game-416x416.bmp 5 15 | cut -d':' -f2 | sed '9,9!d' | xargs echo -n | tee -a ./python/tests_blur/test_radio_cambiando_tamanios_c
#   echo -n " " >> ./python/tests_blur/test_radio_cambiando_tamanios_c
# done
...
# for i in {1..50} 
# do 
#   ./build/tp2 -i c blur ././experimentos/tests_size/tests_size/game-584x584.bmp 5 15 | cut -d':' -f2 | sed '9,9!d' | xargs echo -n | tee -a ./python/tests_blur/test_radio_cambiando_tamanios_c
#   echo -n " " >> ./python/tests_blur/test_radio_cambiando_tamanios_c
# done
...
# for i in {1..50} 
# do 
#   ./build/tp2 -i c blur ././experimentos/tests_size/tests_size/game-824x824.bmp 5 15 | cut -d':' -f2 | sed '9,9!d' | xargs echo -n | tee -a ./python/tests_blur/test_radio_cambiando_tamanios_c
#   echo -n " " >> ./python/tests_blur/test_radio_cambiando_tamanios_c
# done
...
# for i in {1..50} 
# do 
#   ./build/tp2 -i c blur ././experimentos/tests_size/tests_size/game-1160x1160.bmp 5 15 | cut -d':' -f2 | sed '9,9!d' | xargs echo -n | tee -a ./python/tests_blur/test_radio_cambiando_tamanios_c
#   echo -n " " >> ./python/tests_blur/test_radio_cambiando_tamanios_c
# done
...
# for i in {1..20} 
# do 
#   ./build/tp2 -i asm blur ././experimentos/tests_size/tests_size/game-292x292.bmp 5 15 | cut -d':' -f2 | sed '9,9!d' | xargs echo -n | tee -a ./python/tests_blur/test_radio_cambiando_tamanios_asm
...
# for i in {1..20} 
# do 
#   ./build/tp2 -i asm blur ././experimentos/tests_size/tests_size/game-416x416.bmp 5 15 | cut -d':' -f2 | sed '9,9!d' | xargs echo -n | tee -a ./python/tests_blur/test_radio_cambiando_tamanios_asm
#   echo -n " " >> ./python/tests_blur/test_radio_cambiando_tamanios_asm
# done
...
# for i in {1..20} 
# do 
#   ./build/tp2 -i asm blur ././experimentos/tests_size/tests_size/game-584x584.bmp 5 15 | cut -d':' -f2 | sed '9,9!d' | xargs echo -n | tee -a ./python/tests_blur/test_radio_cambiando_tamanios_asm
#   echo -n " " >> ./python/tests_blur/test_radio_cambiando_tamanios_asm
# done
...
# for i in {1..20} 
# do 
#   ./build/tp2 -i asm blur ././experimentos/tests_size/tests_size/game-824x824.bmp 5 15 | cut -d':' -f2 | sed '9,9!d' | xargs echo -n | tee -a ./python/tests_blur/test_radio_cambiando_tamanios_asm
#   echo -n " " >> ./python/tests_blur/test_radio_cambiando_tamanios_asm
# done
...
# for i in {1..20} 
# do 
#   ./build/tp2 -i asm blur ././experimentos/tests_size/tests_size/game-1160x1160.bmp 5 15 | cut -d':' -f2 | sed '9,9!d' | xargs echo -n | tee -a ./python/tests_blur/test_radio_cambiando_tamanios_asm
#   echo -n " " >> ./python/tests_blur/test_radio_cambiando_tamanios_asm
# done
