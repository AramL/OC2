...
python ./python/graficarAlt.py 11 ./python/tests/test_difrencia_ASM_C "diferencia (ASM vs C)" "CPU Ticks"  Assembly "gcc (-O3)" "clang (-O3)" "gcc (-O2)" "clang (-O2)"  "gcc (-O1)" "clang (-O1)"  "gcc (-O0)" "clang (-O0)" "gcc (-Os)" "clang (-Os)"
...
for i in {1..100} 
do 
  ./build/tp2 -i c diff  ./experimentos/tests_size/game-290x290.bmp ./experimentos/tests_size/pokemon-290x290.bmp | cut -d':' -f2 | sed '10,10!d' | xargs echo -n | tee -a ./python/tests/test_performance_size_C
  echo -n " " >> ./python/tests/test_performance_size_C
done


echo "" >> ./python/tests/test_performance_size_C


for i in {1..100} 
do 
  ./build/tp2 -i c diff  ./experimentos/tests_size/game-416x416.bmp ./experimentos/tests_size/pokemon-416x416.bmp  | cut -d':' -f2 | sed '10,10!d' | xargs echo -n | tee -a ./python/tests/test_performance_size_C
  echo -n " " >> ./python/tests/test_performance_size_C
done
...
for i in {1..100} 
do 
  ./build/tp2 -i c diff  ./experimentos/tests_size/game-584x584.bmp ./experimentos/tests_size/pokemon-584x584.bmp  | cut -d':' -f2 | sed '10,10!d' | xargs echo -n | tee -a ./python/tests/test_performance_size_C
  echo -n " " >> ./python/tests/test_performance_size_C
done
...
for i in {1..100} 
do 
  ./build/tp2 -i c diff  ./experimentos/tests_size/game-824x824.bmp ./experimentos/tests_size/pokemon-824x824.bmp  | cut -d':' -f2 | sed '10,10!d' | xargs echo -n | tee -a ./python/tests/test_performance_size_C
  echo -n " " >> ./python/tests/test_performance_size_C
done
...
for i in {1..100} 
do 
  ./build/tp2 -i c diff  ./experimentos/tests_size/game-1160x1160.bmp ./experimentos/tests_size/pokemon-1160x1160.bmp | cut -d':' -f2 | sed '10,10!d' | xargs echo -n | tee -a ./python/tests/test_performance_size_C
  echo -n " " >> ./python/tests/test_performance_size_C
done
...
for i in {1..100} 
do 
  ./build/tp2 -i c diff  ./experimentos/tests_size/game-1632x1632.bmp ./experimentos/tests_size/pokemon-1632x1632.bmp  | cut -d':' -f2 | sed '10,10!d' | xargs echo -n | tee -a ./python/tests/test_performance_size_C
  echo -n " " >> ./python/tests/test_performance_size_C
done
...
for i in {1..100} 
do 
  ./build/tp2 -i c diff  ./experimentos/tests_size/game-2308x2308.bmp ./experimentos/tests_size/pokemon-2308x2308.bmp  | cut -d':' -f2 | sed '10,10!d' | xargs echo -n | tee -a ./python/tests/test_performance_size_C
  echo -n " " >> ./python/tests/test_performance_size_C
done
...
for i in {1..100} 
do 
  ./build/tp2 -i c diff  ./experimentos/tests_size/game-3264x3264.bmp ./experimentos/tests_size/pokemon-3264x3264.bmp  | cut -d':' -f2 | sed '10,10!d' | xargs echo -n | tee -a ./python/tests/test_performance_size_C
  echo -n " " >> ./python/tests/test_performance_size_C
done
...
for i in {1..100} 
do 
  ./build/tp2 -i c diff  ./experimentos/tests_size/game-4620x4620.bmp ./experimentos/tests_size/pokemon-4620x4620.bmp  | cut -d':' -f2 | sed '10,10!d' | xargs echo -n | tee -a ./python/tests/test_performance_size_C
  echo -n " " >> ./python/tests/test_performance_size_C
done
...
python ./python/graficar.py 9 ./python/tests/test_performance_size_C "diferencia gcc (-O2)" "CPU Ticks"  256kb 512kb 1mb 2mb 4mb 8mb 16mb 32mb 64mb
